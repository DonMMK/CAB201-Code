...
namespace RecipeApp
{
    ...
    class Measure
    {
        ...
        ///     *   Exception message will be "The supplied units must either be null or non-blank.".
        /// </exception>
        public Measure(double quantity, string units)
        {
            ...
            if (!(quantity > 0))
            {
                throw new ArgumentOutOfRangeException("quantity", "Quantity may not be equal to or less than zero.");
            }
            ...
            {
                throw new ArgumentException("The supplied units must either be null or non-blank.", "units");
            }
        ...
        ///     *   Exception message will be "Value is required to be greater than zero."
        /// </exception>
        public void Scale(double factor)
        {
            if (factor <= 0)
            {
                throw new ArgumentOutOfRangeException("factor", "Value is required to be greater than zero.");
            }
    ...
    class Ingredients
    {
        ...
        /// <summary>
        ///     Initialise an instance of Ingredients, set for 1 Serving.
        /// </summary>
        public Ingredients()
        {
        ...
        ///     *   Exception message will be "Quantity may not be null."
        /// </exception>
        /// <exception cref="ArgumentException">
        ///     If ingredientName is not null, but entirely consists of white space: 
        ///     *   Exception parameter will be "ingredientName".
        ///     *   Exception message will be "Supplied ingredient name may not be empty or white space."
        /// </exception>
        public void Add(string ingredientName, Measure quantity)
        {
            if (ingredientName == null)
            {
                throw new ArgumentNullException("ingredientName", "Non-null string is required for ingredient name.");
            }

            else if (String.IsNullOrWhiteSpace(ingredientName))
            {
                throw new ArgumentException("Supplied ingredient name may not be empty or white space.", "ingredientName");
            }

            if (quantity == null)
            {
                throw new ArgumentNullException("quantity", "Quantity may not be null.");
            }
        ...
        {
            if (String.IsNullOrEmpty(ingredientName) || ingredientName.Trim().Length == 0)
            {
                throw new ArgumentNullException("ingredientName", "Non-null string is required for ingredient name.");
            }
        ...
        ///     *   Exception message will be "'X' cannot be found in the collection.", where X
        ...
        public Measure Get(string ingredientName)
        {
            ...
            else
            {
                ...
                {
                    throw new RecipeError("'" + ingredientName + "' cannot be found in the collection.");
                }
            }
        ...
        ///     *   Exception parameter will be "Servings".
        ///     *   Exception message will be "Value is required to be greater than zero."
        /// </exception>
        public int Servings
        {
        ...
        /// <summary>
        ///     Gets text representing this Ingredients object.
        /// </summary>
        /// <returns>
        ///     
        /// </returns>
    ...
    class Program
    {
        static Ingredients shoppingList = new Ingredients();
